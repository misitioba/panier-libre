module.exports = app => {
    return async function getDashboardData() {
        /* let query = `
                                                ...
                                                ` */
        let query = `
        SELECT orderItem.id, c.email, orderItem.quantity,b.id as basket_id, o.creation_date as booking_date, b.delivery_date, orderItem.is_canceled, o.observation as observation
        FROM baskets as b
